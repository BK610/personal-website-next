...
export default class MusicItem extends Component {
  ...
  render() {
    return (
      <div
        className="bg-gradient-to-r from-violet-100 to-orange-100 dark:from-violet-600 dark:to-orange-400
      hover:from-violet-200 hover:to-orange-200 hover:dark:from-violet-700 hover:dark:to-orange-500
      border-2 rounded-lg border-violet-300 dark:border-zinc-300
      shadow-md shadow-violet-300 hover:shadow-violet-300 dark:shadow-violet-800 hover:dark:shadow-violet-800
      overflow-hidden
      flex flex-col
